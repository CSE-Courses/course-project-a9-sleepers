...
export default function VisualDesktop (){
  ...
  const MAP = {
    ...
    name: "my-map",
    areas: [
      { name: "Google", shape: "poly", coords: [640,350,1290,350,1290,810 ,640,810],  href : '/Currency' , strokeColor:"blue",},
      ...
      { name: "Currency", shape: "poly", coords: [1570,350,1730,370,1700,450,1540,450],  href:'/Currency' ,strokeColor:"green", coords: [1200,980,1270,925,1420,1000,1330,1100]  }
